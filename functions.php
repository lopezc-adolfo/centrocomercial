...
function gymfitness_scripts_styles() {
    ...
    wp_enqueue_style('gymfitness-styles', get_stylesheet_uri(), [], filemtime( get_stylesheet_directory() . '/style.css' ), 'all'); //Modo desarrollo para evitar el caché
    //wp_enqueue_style('style', get_stylesheet_uri(), array(), '1.0.0'); Modo producción
...
function gymfitness_ubicacion_shortcode() {
    ...
    <?php
    echo do_shortcode('[contact-form-7 id="819774f" title="Formulario de contacto 1"]');
}

add_shortcode('gymfitness_ubicacion', 'gymfitness_ubicacion_shortcode');

/** Imágenes dinámicas con BG **/
